      ...
      <div className="container">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-white/60 mb-6 leading-relaxed">
              ...
              craftsmanship, honest service, and floors that last.
            </p>
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[var(--color-accent)] transition-colors"
              >
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                <Phone size={18} />
                <span>780-655-5230</span>
              </a>
              <div className="flex items-start gap-3 text-white/60">
                <MapPin size={18} className="flex-shrink-0 mt-1" />
                <span>Edmonton & Surrounding Areas, Alberta</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            &copy; {new Date().getFullYear()} HK Flooring. All rights reserved.
          </p>
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 text-white/60 hover:text-[var(--color-accent)] transition-colors"
          >
